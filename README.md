...
This app is the first app I've developed with Swift. This application consists of 3 parts. There is a "Label" at the top of the application, an "ImageView" below it, and a "Button" below it. Picture changing feature is assigned to the button. In addition, an application icon has been added to the application.
...
https://user-images.githubusercontent.com/68854616/188873944-489be77a-b7d1-4453-86dd-1da9271dc0b1.mp4
